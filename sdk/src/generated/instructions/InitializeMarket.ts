 ...
 * @category InitializeMarket
 * @category generated
 */
export const InitializeMarketStruct = new beet.BeetArgsStruct<{
  instructionDiscriminator: number
}>([['instructionDiscriminator', beet.u8]], 'InitializeMarketInstructionArgs')
/**
 * Accounts required by the _InitializeMarket_ instruction
 *
 ...
 * @property [_writable_, **signer**] marketCreator The market_creator account must sign for the creation of new vaults
 * @property [] baseMint Base mint account
 * @property [] quoteMint Quote mint account
...
/**
 * Creates a _InitializeMarket_ instruction.
 *
